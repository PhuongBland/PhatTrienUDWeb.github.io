...
if ($pheptinh == 'cong') {
    $ketqua = $st1 + $st2;
    $nhan_phep_tinh = 'Cộng';
    setcookie("ketqua","$ketqua",time()+3600,"/","",0);
        ...
        <div class="col-md-8 col-lg-6">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $st1; ?>" disabled>
                </div>
                <div class="form-group">
                    <label for="">So thu hai</label>
                    <input type="text" class="form-control" value="<?php echo $st2; ?>" disabled>
                </div>
                <div class="form-group">
